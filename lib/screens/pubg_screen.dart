  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Top-Up PUBG Mobile'),
        centerTitle: true,
      ),
      body: Stack(
        children: [
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: Column(
                      children: [
                        ...
                        const Text(
                          'UC PUBG Mobile cepat, aman, dan terpercaya',
                          style: TextStyle(
                            fontSize: 16,
                  ...
                  GridView(
                    ...
                    children: [
                      _buildNominalCard(context, '30 UC', 7000),
                      _buildNominalCard(context, '60 UC', 14000),
                      _buildNominalCard(context, '325 UC', 70000),
                      _buildNominalCard(context, '660 UC', 140000 ),
                      _buildNominalCard(context, '1800 UC', 350000),
                      _buildNominalCard(context, '3850 UC', 700000),
                      _buildNominalCard(context, '8100 UC', 1400000),
                    ],
                  ),
                ],
              ),
